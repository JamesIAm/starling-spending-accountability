...
public class SpendingCategoriesService {
    public static final String SPENDING_CATEGORY_URI_TEMPLATE = "https://api.starlingbank.com/api/v2/accounts/%s/spending-insights/spending-category?year=2024&month=JULY";
